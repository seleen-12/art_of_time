...
class StudentAdvicesScreen extends StatefulWidget {
  const StudentAdvicesScreen({super.key, required this.title});

  final String title;

  @override
  State<StudentAdvicesScreen> createState() => StudentAdvicesState();
}

class StudentAdvicesState extends State<StudentAdvicesScreen> {
